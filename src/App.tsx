...
export default function RoofImpactDashboard() {
  ...
  // Disabled for now - keeping the state but not using it
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 space-y-8">
        ...
        {/* Main Calculator - Only Standard Mode */}
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
          <div className="flex items-center space-x-3 mb-6">
            <Calculator className="w-6 h-6 text-green-600" />
            <h2 className="text-xl font-semibold text-gray-900">Environmental Impact Calculator</h2>
            <HelpTooltip content="Calculate the environmental impact and costs of sustainable roofing solutions. Configure your roof size, type, and solar options to see detailed projections." />
          </div>
