            ...
            <div className="space-y-3">
              <label className="flex items-start space-x-3 cursor-pointer">
                ...
                <span className="text-sm text-gray-700">
                  I accept the privacy policy and consent to receiving a detailed email with my calculation results *
                </span>
              </label>
              ...
              <label className="flex items-start space-x-3 cursor-pointer">
                ...
                />
                <span className="text-sm text-gray-700">
                  Yes, send me news and relevant updates about sustainable roofing solutions
                </span>
              </label>
            </div>
